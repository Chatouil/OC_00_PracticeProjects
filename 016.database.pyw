...
def dbquery():
	...
	for record in records:
		...
		query_label = Label(scrollable_frame, text=print_records, anchor=W, justify="left", width=38, bg=themeBrightcolor, padx=5)
...
frame.grid(row=8, column=0, columnspan=2, padx=20, pady=(0,20), ipady=0, sticky=NSEW)
